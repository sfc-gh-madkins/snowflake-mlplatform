...
def airport_weather_transform_V2(airport_weather_df: DataFrame):
    """
...
def airport_weather_feature_view_V2(
    ...
    airport_weather_fv = FeatureView(
        ...
        feature_df=airport_weather_transform_V2(airport_weather_df),
